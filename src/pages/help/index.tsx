      ...
      <CustomCard bordered mt={20}>
        ...
        <Form layout="vertical">
          <Row gutter={formGutter}>
            <InputFormItem label="Input" placeholder="Input" />
            <DateFormItem label="Date" placeholder="xx.xx.xxxx" message="" />

            <InputFormItem label="Otp input" otp />
            <InputFormItem
              label="Textarea"
            ...
            <PhoneFormItem label="Ism" placeholder="xx.xx.xxxx" />
            <SelectFormItem
              placeholder="70x100"
              options={[
